...
export interface BridgeDAOInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOT_TYPEHASH"
      | "CLOCK_MODE"
...
export interface BridgeDAO extends BaseContract {
  connect(runner?: ContractRunner | null): BridgeDAO;
  waitForDeployment(): Promise<this>;

  interface: BridgeDAOInterface;
